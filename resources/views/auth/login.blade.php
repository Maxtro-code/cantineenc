...
<div class="w-full max-w-5xl flex flex-col items-center">
    ...
    <main class="w-full flex flex-col lg:flex-row shadow-2xl rounded-[3rem] overflow-hidden glass-card">
        <div class="flex-1 p-8 lg:p-14">
            ...
            <div class="mt-8 text-center text-xs"><a href="{{ route('register') }}" class="text-gray-400 hover:text-[--enc-red]">Pas de compte ? <span class="font-bold border-b border-[--enc-red]">S'inscrire</span></a></div>
        </div>
